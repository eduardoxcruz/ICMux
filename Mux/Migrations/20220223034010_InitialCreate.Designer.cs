...
namespace Mux.Migrations
{
    ...
    [Migration("20220223034010_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mux.Model.ProductCategories", b =>
                {
            ...
            modelBuilder.Entity("Mux.Model.ProductToBuy", b =>
                {
                    ...
                    b.Property<decimal?>("OriginalProductPirce")
                        .HasPrecision(8, 6)
                        .IsUnicode(true)
                    ...
                    b.Property<decimal?>("ProductPriceWithIva")
                        .HasPrecision(8, 6)
                        .IsUnicode(true)
                        .HasColumnType("decimal(8,6)");
            ...
            modelBuilder.Entity("Mux.Model.ProductCategories", b =>
                {
                    b.HasOne("Mux.Model.Category", "Category")
            ...
            modelBuilder.Entity("Mux.Model.ProductToBuy", b =>
                {
                    b.HasOne("Mux.Model.Employee", "Petitioner")
                        .WithMany()
                    ...
                    b.HasOne("Mux.Model.Employee", "Seller")
                        .WithMany("ShoppingCart")
